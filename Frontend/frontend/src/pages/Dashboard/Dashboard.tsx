...
export default function Dashboard() {
  ...
  const handleConnectGitHub = async () => {
    ...
    try {
      ...
      if (!response.ok) throw new Error('GitHub App URL alınamadı');
      const data = await response.json();
          ...
          <div className="content-card">
            <div className="card-header">
              ...
              {githubStatus.connected ? (
                <button onClick={handleSyncRepos} className="sync-button" disabled={isSyncingRepos}>
                  {isSyncingRepos ? (
                    <><span className="spinner-small"></span>Senkronize ediliyor...</>
                  ) : (
            ...
            {isLoadingRepos ? (
              ...
              <div className="empty-state">
                ...
                <p>GitHub App yüklü ama hiç repo seçilmemiş.</p>
              </div>
            ) : (
          ...
          <div className="content-card">
            ...
            <div className="risk-overview">
              <div className="risk-item high">
                <div className="risk-bar"><div className="risk-fill" style={{ width: '75%' }}></div></div>
              ...
              <div className="risk-item medium">
                <div className="risk-bar"><div className="risk-fill" style={{ width: '50%' }}></div></div>
                <div className="risk-info">
              ...
              <div className="risk-item low">
                <div className="risk-bar"><div className="risk-fill" style={{ width: '25%' }}></div></div>
                <div className="risk-info">
